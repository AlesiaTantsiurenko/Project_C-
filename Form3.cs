...
namespace Class_Student_Teacher
{
    public partial class Form3 : Form
    {
        ...
        private void buttonaddtolist_Click(object sender, EventArgs e)
        {
            ...
            {
                string title, description,  message = "Список уже содержит учителей под именем";
                DateTime date;
                string currentname = (string)comboBoxliststudents.SelectedItem;
        ...
        private void xmlToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            if (isselectedtextbox(comboBoxliststudents))
            {
                ...
                {
                    MessageBox.Show("Файл CourseWorks.xml еще не создан!", "Ошибка - несозданный файл");
                }
            }
            else MessageBox.Show("Не выбран преподаватель!", "Ошибка");
        }
        ...
        private void soapToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            if (isselectedtextbox(comboBoxliststudents))
            {
                ...
                {
                    MessageBox.Show("Файл CourseWorks.soap еще не создан!", "Ошибка - несозданный файл");
                }
            }
            else MessageBox.Show("Не выбран преподаватель!", "Ошибка");
        }
